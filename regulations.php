<?php
// หน้าอยู่ระหว่างการจัดทำ — คู่มือบริหาร
?>
<!DOCTYPE html>
<html lang="th">
<head>
    ...
    <title>คู่มือบริหาร - กลุ่มงานการพยาบาล โรงพยาบาลปากช่องนานา</title>
...
<div class="page-header">
    <div class="container d-flex justify-content-between align-items-center flex-wrap gap-2">
        <h1><i class="bi bi-journal-bookmark-fill me-2"></i>คู่มือบริหาร</h1>
    </div>
</div>
...
<div class="container my-5">
    <div class="row justify-content-center">
        ...
        <p>หน้า "คู่มือบริหาร" อยู่ระหว่างการจัดทำ</p>
...
<script>window.CONTENT_SECTION = 'regulations';</script>

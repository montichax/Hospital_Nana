<?php
// =====================================================================
//  ห้องผ่าตัด — หน้าหอผู้ป่วย/หน่วยงาน
//  ดึงข้อมูลจากตาราง department_contents โดยอ้างอิง department_id = 11
// =====================================================================
require_once 'connect.php';

$DEPT_ID   = 11;
$DEPT_NAME = 'ห้องผ่าตัด';
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dept-nav-dropdown" aria-labelledby="grp<?= $gi ?>">
                            ...
                            <?php else: ?>
                                ...
                                ?>
                                    <li>
                                        <a class="dropdown-item dept-nav-leaf" href="dept_operating_room.php?show_personnel=1">
                                ...
                                <?php else: ?>
                                    <li>
                                        <a class="dropdown-item dept-nav-leaf" href="dept_operating_room.php?id=<?= (int)$it['id'] ?>">

<?php
// หน้าอยู่ระหว่างการจัดทำ — เอกสารดาวน์โหลด
?>
<!DOCTYPE html>
<html lang="th">
<head>
    ...
    <title>เอกสารดาวน์โหลด - กลุ่มงานการพยาบาล โรงพยาบาลปากช่องนานา</title>
...
<div class="page-header">
    <div class="container d-flex justify-content-between align-items-center flex-wrap gap-2">
        <h1><i class="bi bi-file-earmark-arrow-down-fill me-2"></i>เอกสารดาวน์โหลด</h1>
    </div>
</div>
...
<div class="container my-5">
    <div class="row justify-content-center">
        ...
        <p>หน้า "เอกสารดาวน์โหลด" อยู่ระหว่างการจัดทำ</p>
...
<script>window.CONTENT_SECTION = 'downloads';</script>

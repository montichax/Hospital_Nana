<?php
// =====================================================================
//  พิเศษชั้น5 — หน้าหอผู้ป่วย/หน่วยงาน
//  ดึงข้อมูลจากตาราง department_contents โดยอ้างอิง department_id = 5
// =====================================================================
require_once 'connect.php';

$DEPT_ID   = 5;
$DEPT_NAME = 'พิเศษชั้น5';
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dept-nav-dropdown" aria-labelledby="grp<?= $gi ?>">
                            ...
                            <?php else: ?>
                                ...
                                ?>
                                    <li>
                                        <a class="dropdown-item dept-nav-leaf" href="dept_private_floor5.php?show_personnel=1">
                                ...
                                <?php else: ?>
                                    <li>
                                        <a class="dropdown-item dept-nav-leaf" href="dept_private_floor5.php?id=<?= (int)$it['id'] ?>">

<?php
// หน้าอยู่ระหว่างการจัดทำ — อบรม / สัมมนา
?>
<!DOCTYPE html>
<html lang="th">
<head>
    ...
    <title>อบรม / สัมมนา - กลุ่มงานการพยาบาล โรงพยาบาลปากช่องนานา</title>
...
<div class="page-header">
    <div class="container d-flex justify-content-between align-items-center flex-wrap gap-2">
        <h1><i class="bi bi-mortarboard-fill me-2"></i>อบรม / สัมมนา</h1>
    </div>
</div>
...
<div class="container my-5">
    <div class="row justify-content-center">
        ...
        <p>หน้า "อบรม / สัมมนา" อยู่ระหว่างการจัดทำ</p>
...
<script>window.CONTENT_SECTION = 'training';</script>

<?php
// =====================================================================
//  สูติ-นรีเวช — หน้าหอผู้ป่วย/หน่วยงาน
//  ดึงข้อมูลจากตาราง department_contents โดยอ้างอิง department_id = 10
// =====================================================================
require_once 'connect.php';

$DEPT_ID   = 10;
$DEPT_NAME = 'สูติ-นรีเวช';
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dept-nav-dropdown" aria-labelledby="grp<?= $gi ?>">
                            ...
                            <?php else: ?>
                                ...
                                ?>
                                    <li>
                                        <a class="dropdown-item dept-nav-leaf" href="dept_obgyn.php?show_personnel=1">
                                ...
                                <?php else: ?>
                                    <li>
                                        <a class="dropdown-item dept-nav-leaf" href="dept_obgyn.php?id=<?= (int)$it['id'] ?>">

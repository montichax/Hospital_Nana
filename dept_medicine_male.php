<?php
// =====================================================================
//  อายุรกรรมชาย — หน้าหอผู้ป่วย/หน่วยงาน
//  ดึงข้อมูลจากตาราง department_contents โดยอ้างอิง department_id = 12
// =====================================================================
require_once 'connect.php';

$DEPT_ID   = 12;
$DEPT_NAME = 'อายุรกรรมชาย';
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dept-nav-dropdown" aria-labelledby="grp<?= $gi ?>">
                            ...
                            <?php else: ?>
                                ...
                                ?>
                                    <li>
                                        <a class="dropdown-item dept-nav-leaf" href="dept_medicine_male.php?show_personnel=1">
                                ...
                                <?php else: ?>
                                    <li>
                                        <a class="dropdown-item dept-nav-leaf" href="dept_medicine_male.php?id=<?= (int)$it['id'] ?>">

<?php
// หน้าอยู่ระหว่างการจัดทำ — แผนพัฒนาบุคลากร
?>
<!DOCTYPE html>
<html lang="th">
<head>
    ...
    <title>แผนพัฒนาบุคลากร - กลุ่มงานการพยาบาล โรงพยาบาลปากช่องนานา</title>
...
<div class="page-header">
    <div class="container d-flex justify-content-between align-items-center flex-wrap gap-2">
        <h1><i class="bi bi-graph-up-arrow me-2"></i>แผนพัฒนาบุคลากร</h1>
    </div>
</div>
...
<div class="container my-5">
    <div class="row justify-content-center">
        ...
        <p>หน้า "แผนพัฒนาบุคลากร" อยู่ระหว่างการจัดทำ</p>
...
<script>window.CONTENT_SECTION = 'staff_dev_plan';</script>
